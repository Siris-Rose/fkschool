...
id_of_mentality = 'E' + raw_id[1:]                                                  # 思想状况ID
...
driver.find_element_by_id(id_of_mentality).click()                                  # 坑死了
driver.find_element_by_id(id_of_mentality).click()                                  # 代码不规范，自动化两行泪。
driver.find_element_by_class_name('fr-trigger-center').click()
button = driver.find_elements_by_class_name('fr-combo-list')[0]                     # lst[0]。。拿到表单了~
